...
```bash
docker pull ghcr.io/anndreloopez012/campuslands-devs-typescript:dev
docker run --rm -p 8080:80 ghcr.io/anndreloopez012/campuslands-devs-typescript:dev
```
...
- `dev` publica la etiqueta `ghcr.io/anndreloopez012/campuslands-devs-typescript:dev`.
- `main` publica la etiqueta `ghcr.io/anndreloopez012/campuslands-devs-typescript:latest`.
